...
- [CSS @media breakpoints](https://www.w3schools.com/cssref/css3_pr_mediaquery.asp)
- [CSS flexbox](https://css-tricks.com/snippets/css/a-guide-to-flexbox/)
- [CSS sticky element](https://www.w3schools.com/howto/howto_css_sticky_element.asp)
...
- [HTML+CSS page load](https://youtu.be/zWB219zf1og)
- [CSS transition](https://www.joshwcomeau.com/animation/css-transitions/)
- [CSS animated background](https://codepen.io/P1N2O/pen/pyBNzX)
- [HTML+CSS hover-to-play gif](https://codepen.io/QDeltaE/pen/VWGYOB)
- [CSS trigger A with B](https://stackoverflow.com/questions/4502633/how-to-affect-other-elements-when-one-element-is-hovered)
- [HTML+CSS details element](https://css-tricks.com/two-issues-styling-the-details-element-and-how-to-solve-them/)
- [CSS hide scrollbar](https://dev.to/ashwamegh/how-to-hide-scrollbar-from-any-html-element-dae)
...
- [CSS customize selection color](https://www.w3schools.com/howto/howto_css_text_selection.asp)

### Text:
- [CSS font family overview](https://www.tutorialbrain.com/css_tutorial/css_font_family_list/)
- [CSS font stack - Helvetica](https://css-tricks.com/snippets/css/better-helvetica/)
- [CSS font stack - Georgia](https://www.cssfontstack.com/georgia)
- [HTML sub- & super-script](https://stackoverflow.com/questions/3742975/subscript-and-superscript-for-the-same-element)
- [HTML+CSS text with image filling](https://www.geeksforgeeks.org/how-to-add-image-in-text-background-using-html-and-css/)

### Icon:
- [fontawesome](https://fontawesome.com/)
- [fontawesome icon code example](https://www.w3schools.com/icons/tryit.asp?filename=tryicons_fa-instagram)
