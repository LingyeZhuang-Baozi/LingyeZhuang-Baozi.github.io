...
export const journey = [
	...
	[ ["2021", [require("./assets/journey/zodiacs/animal_ox_light@2x.png"), require("./assets/journey/zodiacs/animal_ox_dark@2x.png")], "year of the Ox, the 2nd animal in the Chinese zodiac"],
		...
		[
			...
			[ ["Ambulance dispatching system redesign for Cruz Roja", "The Red Cross, Global TIES"],
				...
				[ [ 2,
					[ ["img-static", require("./assets/journey/2021/2_cruzroja/prototype_1.png"), "CruzRoja prototype 1", "",],
						["img-static", require("./assets/journey/2021/2_cruzroja/prototype_2.png"), "CruzRoja prototype 2", "",], ],
			...
			[ ["Upgrade website for ACM@UCSD", "ACM@UCSD"],
				...
				[ [ 2,
					[ ["img-static", require("./assets/journey/2021/3_acm/home.png"), "ACM home page", "",],
						["img-static", require("./assets/journey/2021/3_acm/communities_1.png"), "ACM communities page 1", "",],
						["img-static", require("./assets/journey/2021/3_acm/communities_2.png"), "ACM communities page 2", "",], ],
	...
	[ ["2022", [require("./assets/journey/zodiacs/animal_tiger_light@2x.png"), require("./assets/journey/zodiacs/animal_tiger_dark@2x.png")], "year of the Tiger, the 3rd animal in the Chinese zodiac"],
		...
		[
			...
			[ ["Volunteer hub to help granting wishes to children", "Make-A-Wish, TSE"],
				...
				[ [ 2,
					[ ["img-static", require("./assets/journey/2022/2_maw/volunteers_management.png"), "MAW volunteers management", "",],
						...
						["img-static", require("./assets/journey/2022/2_maw/calendar.png"), "MAW calendar page", "",], ],
			...
			[ ["Theatre design moodboards for a modern interpretation of A Midsummer Night's Dream", "TDDE 1"], [],
				[ [ 1,
					[ ["img-zoomable", require("./assets/journey/2022/5_theatre_design/vibe_moodboard.png"), "new A Midsummer Night's Dream vibe moodboard", "",],
						["img-zoomable", require("./assets/journey/2022/5_theatre_design/concept_moodboard.png"), "new A Midsummer Night's Dream 3D concept moodboard", "",],
						["img-zoomable", require("./assets/journey/2022/5_theatre_design/character_moodboard_bottom.png"), "new A Midsummer Night's Dream character moodboard for Bottom", "",],
						["img-zoomable", require("./assets/journey/2022/5_theatre_design/character_moodboard_titania.png"), "new A Midsummer Night's Dream character moodboard for Titania", "",],
						["img-zoomable", require("./assets/journey/2022/5_theatre_design/custom_design.png"), "new A Midsummer Night's Dream custom design sketches", "",], ],
				], ],
			],

			[ ["Design opportunity seeking presentation on layering", "DSGN 118"], [],
				[ [ 2,
					[ ["vid", require("./assets/journey/2022/6_problem_seeking/layer_problem_presentation.mp4"), "", "", "100%", require("./assets/journey/2022/6_problem_seeking/layer_problem_presentation_thumbnail.png"),], ],
			...
			[ ["3D art", "VIS 3, CSE 167"], [],
				[ [ 1,
					[ ["img-zoomable", require("./assets/journey/2022/7_3d_art/1min_sculpture.png"), "1 minute sculpture", "",],
						["img-zoomable", require("./assets/journey/2022/7_3d_art/dantea_and_virgil.png"), "recreate painting with body - Dantea and Virgil", "",],
						["img-zoomable", require("./assets/journey/2022/7_3d_art/to_verbalize.png"), "3 of my to-verbalize pieces", "",], ],
				], [ 1,
					[ ["img-zoomable", require("./assets/journey/2022/7_3d_art/volcano_hat.png"), "volcano hat", "",],
						["img-zoomable", require("./assets/journey/2022/7_3d_art/wearable_mask_of_explosion.jpg"), "mask of explosion", "",],
						["img-zoomable", require("./assets/journey/2022/7_3d_art/monument_seesaw.png"), "20220524 monument - seesaw", "",],
						["img-zoomable", require("./assets/journey/2022/7_3d_art/body_extension_slinky.gif"), "body extension project - slinky", "",],
						["img-zoomable", require("./assets/journey/2022/7_3d_art/with_plastered_brick_totem.jpg"), "photo at an exhibition", "",],
						["img-zoomable", require("./assets/journey/2022/7_3d_art/mad_hatters_afternoon_tea.png"), "computational art rendering - mad hatter's afternoon tea", "",], ],
				], ],
			],

			// [ ["...", "COGS 100"], [],
			// 	[ [ 2,
			// 		[ ["img-static", require("./assets/journey/2022/8_cogs100/....png"), "...", "",], ],
			// 		"..",
			// 	], ],
			// ],
			...
			[ ["Dear inheritor, interactive artpiece", "VIS 147A"], [],
				[ [ 2,
					[ ["img-static", require("./assets/journey/2022/9_electronic_art/the_inheritor_demo.png"), "the inheritor", "",], ],
