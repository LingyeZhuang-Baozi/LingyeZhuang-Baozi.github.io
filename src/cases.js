...
export const casesByCategory = [
	{
		...
		cases: ["ALUM", "Bitsrealm", "CruzRoja", "ACM", "CharmLife", "MercuryAlert", "LAK", "MAW", "Atlas", /*"GroupReads",*/],
	},
	{
		title: ["Frontend", "前端开发"],
		cases: ["CheeseClub", "CreativityLab",],
	},
	{
		title: ["3D", "3D 建模"],
		cases: ["AsTheWindBlows", /*"3DCG",*/ /*"CellInTheSpace",*/],
	},
	{
		title: ["Marketing", "数字营销"],
		cases: ["TSE",],
	},
	{
		title: ["Illustration", "手绘插画"],
		cases: ["Neureality", "CU",],
	},
	{
		title: ["Conceptualization", "概念设计"],
		cases: ["RehaBuddy", /*"PadPal",*/ "ThriveSD",],
	},
	// {
	// 	title: ["", ""],
	// 	cases: [/*"2DCG",*/ /*"2021Art",*/ /*"2020Art",*/ /*"GaokaoFighting",*/ /*"2022Art",*/ /*"KaonashiRobot",*/],
	// },
];
...
export const cases = {
	...
	"AsTheWindBlows": {
		...
		cn: {
			...
			thumbnail: {
				brief: [
					"负责3D多人游戏角色及地图的设计，自学 Blender 3D建模和动画；",
					"与跨学科团队紧密合作，在10周内密集地测试，迅速迭代；",
					"面向超300名观众汇报演示，现场邀请观众试玩，均获好评。",
				],
				img:
					<Gif
						srcWebm={require("./assets/cases/AsTheWindBlows/thumbnail_img.webm")}
	...
	"ALUM": {
		...
		cn: {
			...
			thumbnail: {
				brief: [
					"主导北木高中校友资源 APP 的 UX/UI 设计，从分析需求至产品交付全程跟进；",
					"作为设计总负责，每周分配和管理设计任务，与客户交接讨论，汇报阶段性成果，收集反馈，确定修改方向；",
					"采用敏捷开发，与项目经理、工程经理及开发人员紧密合作，迈小步勤迭代；",
					"APP将在今夏投入使用，并为超2000名北木高中学生联结校友，提供辅导。",
				],
				img:
					<Img
						srcWebp={require("./assets/cases/ALUM/thumbnail_img.webp")}
	...
	"CheeseClub": {
		...
		cn: {
			title: <>Cheese Club, Webflow 设计开发</>,
			bio: [
				<>Cheese Club @UCSD</>,
				"UI 设计，\nWebflow设计开发",
				<>2023年05月</>,
			...
			thumbnail: {
				brief: [
					"协办创立 Cheese Club，组织社团活动，应对后疫情时代社交难题；",
					"自学 Webflow，独立设计并开发了社团网站，优先考虑响应式设计和维护效率，确立年轻时尚的品牌形象。",
				],
				img:
					<Img
						srcWebp={require("./assets/cases/CheeseClub/thumbnail_img.webp")}
	...
	"CreativityLab": {
		...
		cn: {
			...
			thumbnail: {
				brief: [
					"带领3名队员，自学 ReactJS，在导师指导下，设计并开发了一个面向交互手势设计师的数据库网站，辅助分析日常情境，引导AR环境下的手势设计。",
				],
				img:
					<Img
						srcWebp={require("./assets/cases/CreativityLab/thumbnail_img.webp")}
	...
	"TSE": {
		...
		cn: {
			...
			thumbnail: {
				brief: [
					"负责设计社交媒体图文，海报传单，周边商品等宣传资产，与活动策划人紧密合作，运营 Instagram 和 Facebook 账号，1年内吸引了300+新的关注。",
					"建立基于原子设计的设计体系，在 Figma 中规范设计变量，制作UI组件库，提升本社团产品设计效率和统一性。",
				],
				img:
					<Img
						srcWebp={require("./assets/cases/TSE/thumbnail_img.webp")}
	...
	"CharmLife": {
		en: {
			...
			thumbnail: {
				brief: [
					"Led redesign of product website, conducted user research, established design system based on findings.",
					"Oversaw frontend development, addressed queries, ensured quality, paving way for for app launch.",
				],
				img:
					<Img
		...
		cn: {
			...
			thumbnail: {
				brief: [
					"主导产品网站的全面改版并质监前端开发；",
					"调研分析目标用户需求，提升品牌形象，展示可信度，为 APP 成功试水铺平道路。",
				],
				img:
					<Img
						srcWebp={require("./assets/cases/CharmLife/thumbnail_img.webp")}
	...
	"MercuryAlert": {
		...
		cn: {
			...
			thumbnail: {
				brief: [
					"主导品牌形象更新及官网全面改版，提升易用性、美观性及可信度，为该创业公司吸引到了种子投资；",
					"每周3次设计和发布社交媒体帖子，成功使 Instagram 账号点赞数提升了了50%；",
					"为社交媒体及幻灯片创作统一且符合新品牌形象的模板，成果至今仍为该公司使用。",
				],
				img:
					<Img
						srcWebp={require("./assets/cases/MercuryAlert/thumbnail_img.webp")}
	...
	"Bitsrealm": {
		...
		cn: {
			...
			thumbnail: {
				brief: [
					"独立对品牌视觉形象及官网进行全面改版，并为该公司首场虚拟音乐会设计一系列网页应用，包括购票网站、演出者端控制台、及手机端观众交互界面，均在6周内完成。",
					"制作用户流程图、低至高保真原型图，每隔天向公司领导者汇报、讨论，根据反馈修改迭代，最终确定方案，切图、归档、并与开发组交接，在前端开发过程中答疑并提出调整意见。",
				],
				img:
					<Img
						srcWebp={require("./assets/cases/Bitsrealm/thumbnail_img.webp")}
	...
	"CruzRoja": {
		...
		cn: {
			...
			thumbnail: {
				brief: [
					"与墨西哥蒂华纳红十字会合作，主导改版其救护车调度系统交互界面；",
					"带领3人跨学科小组，调研需求，精简界面布局，优化信息结构及视觉层级，构思地图上的直接和快捷操作，提升易用性及界面整体逻辑。",
					"该项目正在试运行，旨在最大化利用有限医疗资源，为蒂华纳2百万居民提供更高效可靠的急救服务。",
				],
				img:
					<Img
						srcWebp={require("./assets/cases/CruzRoja/thumbnail_img.webp")}
