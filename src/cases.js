...
import { ReactComponent as ObjectCase } from "./assets/cases/_case/_object.svg";
...
export const casesByTimeline = [
	...
	[	"2019",
	[/*"2DCG",*/ /*"KaonashiRobot",*/ "ChineseUnion"],
...
export const templateHintblobMap = [true, true, false];	// true = L, false = R
...
export const cases = {
	...
	"CheeseClub": {
		title: <>Website for Cheese Club - It’s All About Friendship</>,
		bio: [
			<>Cheese Club @UCSD</>,
	...
	"TSE": {
		...
		thumbnail: {
			brief: <>I wore several hats in TSE, an highly selective student organization at UCSD that has developed software for 20+ nonprofit clients. As the marketing lead, I designed <A href="https://www.instagram.com/ucsd_tse/?hl=en">social media posts</A>, flyers, and merchandise, maintaining a branding that upholds professionalism. I co-established the first design system at TSE, standardizing design tokens and fundamental components for future projects.</>,
	...
	"MAW": {
		...
		bio: [
			<><A href="https://wish.org/sandiego">Make-A-Wish San Diego</A></>,
			<>UX/UI Design</>,
			<>November 2021 - June 2022</>,
		],
		thumbnail: {
			brief: <>The mission of the nonprofit Make-A-Wish is to grant wishes to children with critical illnesses. My team built a volunteer hub that coordinates their diverse volunteer base and smoothens the wish-granting process, supporting the little warriors in the face of health challenges.</>,
	...
	"MercuryAlert": {
		...
		thumbnail: {
			brief: <>Mercury Alert is a senior healthcare startup. As the sole designer on the team, I was in charge of everything design-relevant:<ul><li>I initialized a thorough rebrand and redesigned the <A href="https://www.mercuryalert.ai/">product website</A>, enhancing its usability and credibility, attracted a seed funding for the company.</li><li>I created graphic design for instagram and facebook posts 3 times per week, and increased the like count by 50%.</li><li>I iterated the sponsorship decks, business card, trifold, and questionnaires. The templates I designed are still in use to date.</li></ul></>,
	...
	"Bitsrealm": {
		...
		thumbnail: {
			brief: <>Bitsrealm Technology is a VR game company. As the sole designer on the team, I worked closely with game writers and developers to craft branding and prototypes for 4 digital products, and enabled a successful debut of the company's virtual concerts.</>,
	...
	"CruzRoja": {
		title: <>Ambulance Dispatching System For Red Cross Tijuana</>,
		bio: [
			<>Cruz Roja Tijuana</>,	// UCSD TODAY article: https://today.ucsd.edu/story/lifesaving-app
			<>UX/UI Design, Lead Designer</>,
	...
	"ACM": {
		title: <>Website Upgrade And More For ACM@UCSD</>,
		bio: [
			<>ACM@UCSD</>,
	...
	"Atlas": {
		title: <>Atlas, E-commerce Fullfiller Dashboard</>,
		bio: [
			<>Atlas</>,
			<>UI Design</>,
			<>June 2021</>,
	...
	"RehaBuddy": {
		title: <>RehaBuddy, Electronic Pet Concept To Motivate Stroke Rehabilitation</>,
		bio: [
			<></>,
	...
	"PadPal": {
		...
		bio: [
			<><A href="https://www.projectkiliforkids.org/home2">Project Kilimanjaro</A></>,
	...
	"ThriveSD": {
		...
		thumbnail: {
			brief: <>In response to the Covid-19 outbreak, we proposed a buy-1-give-1 model to recover the supply and consumption chain, and help small restaurants and homeless individuals survive hard time. I collaborated with a group of problem solvers from various walks of life, practiced design thinking, researched stakeholders, and developed this proposal.</>,
			img: require("./assets/cases/_case/_img.png"),
		},
		content: {
			overview: [],
	...
	"Neureality": {
		...
		bio: [
			<><A href="https://neu-reality.com/">Neureality</A></>,
			<>Illustration</>,
	...
	// 	],
	// 	thumbnail: {
	// 		brief: <>This website is <A href="https://github.com/LingyeZhuang-Baozi/LingyeZhuang-Baozi.github.io/tree/master">hand-coded</A> with React.js and <Emoji>💛</Emoji>. Thank you for reading till the end!</>,
	// 		img: require("./assets/cases/_case/_img.png"),
	// 	},
	// 	content: {
	// 		overview: [],
